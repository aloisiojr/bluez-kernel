...
{
	struct hci_cp_le_set_adv_data adv_data;
	...
	memset(&adv_data.data, 0, sizeof(adv_data.data));
	ptr = adv_data.data;
	len = 0;
	...
	adv_data.data_len = len;

	hci_send_cmd(hdev, HCI_OP_LE_SET_ADV_DATA, sizeof(adv_data), &adv_data);
}
